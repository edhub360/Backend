...
class TestInitVectorStore:
    ...
    def test_sets_global_embeddings(self):
        ...
        with patch("app.core.database.GoogleGenerativeAIEmbeddings", return_value=mock_embed),              patch("app.core.database.PGVector"),              patch("app.core.database.settings", self._mock_settings()):
            import app.core.database as db_mod
    ...
    def test_embedding_uses_semantic_similarity_task(self):
        with patch("app.core.database.GoogleGenerativeAIEmbeddings") as mock_embed_cls,              patch("app.core.database.PGVector"),              patch("app.core.database.settings", self._mock_settings()):
            import app.core.database as db_mod
            db_mod.init_vector_store()
    ...
    def test_pgvector_async_mode_enabled(self):
        with patch("app.core.database.GoogleGenerativeAIEmbeddings"),              patch("app.core.database.PGVector") as mock_pg_cls,              patch("app.core.database.settings", self._mock_settings()):
            import app.core.database as db_mod
            db_mod.init_vector_store()
